...
function Search() {
  const [activeHeads, setActiveHeads] = useState("search");
  ...
  return (
    <div className={styles.mainContent}>
      ...
      <div className={styles.searchToggle}>
        <button
          className={activeHeads === "foryou" ? styles.activeToggle : styles.inactiveToggle}
          onClick={() => handleHeadClick("foryou")}
        >
          For you
        </button>
        <button
          className={activeHeads === "people" ? styles.activeToggle : styles.inactiveToggle}
          onClick={() => handleHeadClick("people")}
        >
          People
        </button>
      </div>
      ...
      {activeHeads === "foryou" && <ForYou />}
      {activeHeads === "people" && <People />}
    </div>
  );
}
